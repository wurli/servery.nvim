...
2. Use `:Sv` (or configure keymap) to jump between them
3. Profit
...
* Supports a switching sessions via a bunch of options:
  * Built-in ui
...
served me well but has some rough edges which I'd prefer to avoid, so one
